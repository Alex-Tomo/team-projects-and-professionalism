...
class MathsTemplate5 extends React.Component {
  constructor(props) {
    super(props);
   ...
   handleSubmit(event) {
    ...
    addClick(){
      this.setState(prevState => ({inputs: [...prevState.inputs, {question: "", firstInput: ""}]}))
    }
    ...
    /*  if(this.state.inputs.trim() === "") {
      ...
      alert(this.state.inputs.question + this.state.inputs.firstAnswer)
  ...
  render() {
    ...
    return (
      ...
      <div>
        ...
        <div className="modal is-fullwidth" id = "MathsTemp5">
