...
class MathsTemplate3 extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    return (
      <div className="modal is-fullwidth" id = "MathsTemp3">
      ...
      <div className="modal-card">
        ...
        <button className="button is-danger" data-target = "MathsTemp3">Cancel</button>
        </footer>
      </div>
      </div>
    )
